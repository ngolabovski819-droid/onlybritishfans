  ...
  return (
    <div className="legal-page">
      ...
      <p>
        ...
        site and OnlyFans&apos; privacy policy applies. Creator images are resized and re-encoded on our own
        servers rather than being sent to a third-party image proxy.
      </p>
